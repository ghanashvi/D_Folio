...
contract Portfolio{
  ...
  string public imageLink="QmRtFJStudCdTvDymDDUQRBPmHcVXw1mbXkiysXHNjgnpm";
  string public description="I'M a Blockchain enthusiast and eager to learn about new technologies. I code in Java and love to solve DSA problems.";
  string public resumeLink="QmVwcqVr7HbAJJkUT8b5NdtymrDqEbrPyeR8GkSJjGURcR";
  uint projectCount;
  uint educationCount;
